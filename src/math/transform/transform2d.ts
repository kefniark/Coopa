...
import { IVector3, IVector2 } from "./common"

export class Transform2d {
	public data: number[]

	private _position: number[]
	private _posProxy: IVector2

	private _rotQuat: number[]
	private _rotProxy: IVector3

	private _scale: number[]
	private _scaleProxy: IVector2
	...
	private getPosition() {
		...
		const mat = { x: this._position[0], y: this._position[1] } as IVector2
	...
	private getScale() {
		...
		const mat = { x: this._scale[0], y: this._scale[1] } as IVector2
