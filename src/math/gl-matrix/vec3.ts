 ...
 * @returns {vec3} out
 */
export function hermite(out: number[], a: number[], b: number[], c: number[], d: number[], t: number) {
 ...
 * @returns {vec3} out
 */
export function bezier(out: number[], a: number[], b: number[], c: number[], d: number[], t: number) {
 ...
 * @returns {vec3} out
 */
export function rotateX(out: number[], a: number[], b: number[], rad: number) {
	let p = [],
		r = []
 ...
 * @returns {vec3} out
 */
export function rotateY(out: number[], a: number[], b: number[], rad: number) {
	let p = [],
		r = []
	//Translate point to the origin
	p[0] = a[0] - b[0]
 ...
 * @returns {vec3} out
 */
export function rotateZ(out: number[], a: number[], b: number[], rad: number) {
	let p = [],
		r = []
	//Translate point to the origin
	p[0] = a[0] - b[0]
...
export const forEach = (function() {
	...
	return function(
		...
		offset: number,
		count: number,
		fn: (vec1: number[], vec2: number[], vec3: number[]) => void,
		arg: any
	) {
		let i, l
		if (!stride) {
